...
from INTRO import play_gif #pip uninstall speedtest pip uninstall speedtest-cli pip install speedtest-cli
...
#from INTRO import play_gif  # Importing the play_gif function from INTRO module
#play_gif("ironsnap2.gif")  # Play the intro GIF
